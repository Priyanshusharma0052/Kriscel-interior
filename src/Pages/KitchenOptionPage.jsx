...
import { kitchenOptions } from "../data/siteData";

function KitchenOptionPage() {
  const { slug } = useParams();
  const item = kitchenOptions.find((option) => option.slug === slug);
  ...
  return (
    <PageTransition>
      ...
      <OptionDetails item={item} category="kitchen" />
      <ContactForm />
      <Footer />
    </PageTransition>
  );
...
export default KitchenOptionPage;
