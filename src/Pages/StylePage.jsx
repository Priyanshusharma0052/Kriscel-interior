  ...
  return (
    <PageTransition>
      ...
      <section className="pt-32 section">
        ...
        <img src={item.image} alt={item.title} className="mt-10 rounded-[32px] shadow-soft w-full max-h-[360px] sm:max-h-[500px] md:max-h-[620px] object-cover" />
      </section>
      <OptionDetails item={item} category="style" />
      <Footer />
    </PageTransition>
  );
}
